...
public class Login implements Task {
	...
	public <T extends Actor> void performAs(T actor) {
		...
		try {
			actor.attemptsTo(Click.on(LogeoGao.BTN_LOGIN));
			actor.attemptsTo(Enter.theValue(user).into(LogeoGao.TXT_EMAIL_USER),
					Enter.theValue(password).into(LogeoGao.TXT_PASS), Click.on(LogeoGao.BTN_ADMIT));
