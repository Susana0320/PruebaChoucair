...
public class CommonSteps {
	...
	@Given("I want to login user to web page New Experience")
	public void iWantToLoginUserToWebPageNewExperience() {

		theActorInTheSpotlight().wasAbleTo(OpenBrowser.gao());
